...
- **Global scope**: `/Users/alexshrestha/Documents/pet/AIAgent/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/alexshrestha/Documents/pet/AIAgent/.cursor/notes/`)
...
2. Glob `/Users/alexshrestha/Documents/pet/AIAgent/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/alexshrestha/Documents/pet/AIAgent/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/alexshrestha/Documents/pet/AIAgent/.cursor/notes/` — works in any directory
