...
- Если вопрос узкий («кто выиграл…», «какое место…», «сколько очков…») и в контексте есть имя, команда или цифра — начни message с этого факта (одно–два предложения достаточно).
- Если в контексте явно указан победитель гонки (строка «Итог гонки», «место 1», P1) для нужного Гран-при и года — назови этого пилота и команду; не говори, что данных нет.
